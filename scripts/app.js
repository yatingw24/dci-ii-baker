...
const drawMultiline = () => {
  ...
  function ready(datapoints) {
    ...
    // Add annotation
    let annotationX = chartWidth - 20; // Right edge with some padding
    let annotationY = chartHeight - 20; // Bottom with some padding

    // Find a closer target point (around 2021-2022 instead of 2020-2021)
    ...
    svg
      ...
      .attr('orient', 'auto')
      .append('path')
      .attr('d', 'M0,-5L10,0L0,5') // within the viewbox, draw each dot of the triangle
      .attr('fill', '#666');
    ...
    let controlY = (targetY + curveEndY) / 2 + 20; // curve downward
